...
//after adding this @ControllerAdvice annotation if any exception occurs in the code that error will come to this Class
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> resourceNotFound(
            ...
            //WebRequest will automatically get the object Address
            WebRequest request
    ){
